...
(1,'root','http://127.0.0.1:3000/168733128710103334278761577498-bg.2fa5cb09.jpg',1,'1','管理员',1,'63a9f0ea7bb98050796b649e85481845',5,'2023-06-21 15:08:08','2023-04-05 15:32:33'),
...
CREATE TABLE meteorological_data (
    ...
    `station_code` VARCHAR(255) COMMENT '气象站代码',
    `date_year` VARCHAR(255) COMMENT '年',
    `date_month` VARCHAR(255) COMMENT '月',
    `date_day` VARCHAR(255) COMMENT '日',
    `year_month` VARCHAR(255) COMMENT '年月',
    `year_month_day` VARCHAR(255) COMMENT '年月日',
    `latitude` DECIMAL(10, 8) COMMENT '纬度',
    `longitude` DECIMAL(11, 8) COMMENT '经度',
    `station_elevation` DECIMAL(10, 2) COMMENT '气象站高程',
    `station_name` VARCHAR(255) COMMENT '气象站名称',
    `avg_temperature` DECIMAL(5, 2) COMMENT '平均气温',
    `avg_temperature_attribute` VARCHAR(255) COMMENT '平均气温属性',
    `avg_dew_point` DECIMAL(5, 2) COMMENT '平均露点',
    `avg_dew_point_attribute` VARCHAR(255) COMMENT '平均露点属性',
    `avg_sea_level_pressure` DECIMAL(7, 2) COMMENT '平均海平面压强',
    `avg_sea_level_pressure_attribute` VARCHAR(255) COMMENT '平均海平面压强属性',
    `avg_station_pressure` DECIMAL(7, 2) COMMENT '平均观测站压强',
    `avg_station_pressure_attribute` VARCHAR(255) COMMENT '平均观测站压强属性',
    `avg_visibility` DECIMAL(5, 2) COMMENT '平均能见度',
    `avg_visibility_attribute` VARCHAR(255) COMMENT '平均能见度属性',
    `avg_wind_speed` DECIMAL(5, 2) COMMENT '平均风速',
    `avg_wind_speed_attribute` VARCHAR(255) COMMENT '平均风速属性',
    `max_continuous_wind_speed` DECIMAL(5, 2) COMMENT '最大持续风速',
    `max_continuous_wind_speed_attribute` VARCHAR(255) COMMENT '最大持续风速属性',
    `max_temperature` DECIMAL(5, 2) COMMENT '最高气温',
    `max_temperature_attribute` VARCHAR(255) COMMENT '最高气温属性',
    `min_temperature` DECIMAL(5, 2) COMMENT '最低气温',
    `min_temperature_attribute` VARCHAR(255) COMMENT '最低气温属性',
    `precipitation` DECIMAL(8, 2) COMMENT '降水量',
    `precipitation_attribute` VARCHAR(255) COMMENT '降水量属性',
    `snow_depth` DECIMAL(5, 2) COMMENT '积雪深度',
    `indicator` VARCHAR(255) COMMENT '指示器'
)ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3;


DROP TABLE IF EXISTS `qixiang_data`;

CREATE TABLE qixiang_data (
    `station_code` VARCHAR(255) COMMENT '气象站代码',
    `year_month_day` VARCHAR(255) COMMENT '年月日',
    `latitude` DECIMAL(10, 8) COMMENT '纬度',
    `longitude` DECIMAL(11, 8) COMMENT '经度',
...
-- LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/2022.csv'  -- 文件路径"/",注意这里是没有LOCAL关键字的
-- INTO TABLE qixiang_data -- 在数据库中创建的要插入的表的名称
