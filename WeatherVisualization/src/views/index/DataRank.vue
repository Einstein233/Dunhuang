<template>
    <div class="DataRankWrapper" style="width: 400px; height: 300px;">
        <div id="DataRank" style="width: 95%; height: 95%;"></div>
    </div>
</template>
...
const createChart = () => {
    const myChart = echarts.init(document.getElementById('DataRank'));
